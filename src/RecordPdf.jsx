    ...
    <>
      ...
      <div className="w-screen">
        <div className="flex justify-center items-center px-2 py-3 text-xl relative">
          <div className="absolute top-10 left-10 text-md font-roboto">
          ...
          <div className="absolute top-10 right-10 text-xl text-md font-roboto">
          ...
          <div className="border-2 border-[red] px-4 flex items-center justify-between flex-col h-full w-[30%] rounded-lg rightside gap-y-10 py-8">
            <div className="flex flex-col justify-center">
              ...
              <div className="flex justify-center items-center text-xl font-roboto pt-5">
                <div className="">Scan Me / مسح لي</div>
              </div>
            </div>
